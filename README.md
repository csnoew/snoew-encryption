### Download
This program requires [Python 3.10.2](ttps://www.python.org/downloads/) or newer to be installed. The source code can be viewed at the [Github Repository](https://github.com/csnoew/snoew-encryption/) where you can also install the program.
